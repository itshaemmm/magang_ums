            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-9 text-center mx-auto">
                        <h1 class="text-white font-weight-black pt-3 mt-n5">Pesan Videotron</h1>
                        <p class="lead text-white mt-3">Pelayanan Pemesanan Videotron Dinas Komunikasi dan Informatika
                ...
                <div class="container">
                    <div class="card rounded-4" style="box-shadow: 5px 5px 20px 1px rgba(0,0,0, 0.20)">
                        ...
                        <form action="{{ route('videotron.store') }}" method="POST" class="p-4 row">
                            ...
                            <div class="mb-3">
                                <label class="form-label fw-bold">Contact Peminjam</label>
                                <input type="tel" pattern="[0-9]{10,15}" name="contact_peminjam"
                                    class="form-control border border-2 shadow-sm px-2" required>
                            </div>
                            <div class="mb-3">
