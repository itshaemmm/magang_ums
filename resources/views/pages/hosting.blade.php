            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-9 text-center mx-auto">
                        <h1 class="text-white font-weight-black pt-3 mt-n5">Website Hosting</h1>
                        <p class="lead text-white mt-3">Pelayanan Website Hosting Dinas Komunikasi dan Informatika
                    ...
                    <div class="card rounded-4" style="box-shadow: 5px 5px 20px 1px rgba(0,0,0, 0.20)">
                        ...
                        <form action="{{ route('hosting.store') }}" method="POST" class="p-4 row">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="tel" pattern="[0-9]{10,15}" name="contact_user"
                                    class="form-control border border-2 shadow-sm px-2" required>
                            </div>
                            <div class="mb-3">
